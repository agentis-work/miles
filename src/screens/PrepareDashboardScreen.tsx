    ...
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <Card>
        <View style={styles.progressRow}>
          <View style={[styles.ring, { borderColor: theme.colors.accent, borderRadius: theme.spacing.xxl + theme.spacing.xs - 2 }]}>
            <Text style={[styles.ringText, theme.typography.body, { color: theme.colors.textPrimary }]}>{completion}%</Text>
          </View>
          <View style={{ flex: 1 }}>
            <Text style={[theme.typography.h3, { color: theme.colors.textPrimary }]}>Ready to depart</Text>
            <Text style={[styles.progressMeta, theme.typography.bodyStrongSmall, { color: theme.colors.textSecondary }]}>Checklist progress is mocked for this phase.</Text>
          </View>
        </View>
      </Card>
      ...
      <Card>
        ...
        <Text style={[styles.cardMeta, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>Manage flights, stay, and transfer confirmations.</Text>
      ...
      <Card>
        ...
        <Text style={[styles.line, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>- Passport and visa ready</Text>
        <Text style={[styles.line, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>- Transfer details confirmed</Text>
        <Text style={[styles.line, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>- Essentials packed</Text>
      </Card>

      <Card>
        <Text style={[theme.typography.h3, { color: theme.colors.textPrimary }]}>Trip Framework</Text>
        <Text style={[styles.cardMeta, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>
      ...
      <Card>
        ...
        <Text style={[styles.line, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>- Keep digital copies of documents.</Text>
        <Text style={[styles.line, theme.typography.bodySmall, { color: theme.colors.textSecondary }]}>- Confirm airport transfer 24h before departure.</Text>
      </Card>

      <Text style={[styles.debug, theme.typography.overline, { color: theme.colors.textSecondary }]} onPress={() => advanceTripStatus(trip.id)}>
        Start trip (debug)
      </Text>
    </ScrollView>
  );
